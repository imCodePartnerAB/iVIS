...
public class IvisDomainClassConverter{}//<T extends ConversionService & ConverterRegistry> implements
...
//
//        return serviceFactory.hasRepositoryFor(targetType.getType()) ? toEntityConverter.convert(source, sourceType,
...
//
//            RepositoryInformation info = serviceFactory.getRepositoryInformationFor(domainType);
