...
<div class="container">
    <div class="content">
        <div class="box">
            ...
            <form method="post" enctype="multipart/form-data" name="xmlForm" action="<%=Imcms.getServerProperties().getProperty("ClientAddress")%>/api/content/ivis/xml">
                <div class="field">
...
<%--//    if (token == null) {--%>
<%--%>--%>
<%--&lt;%&ndash;//        response.sendRedirect("http://localhost:8080/ivis/oauth/authorize?client_id=2e9fa895-e577-4156-844a-2cbb1ebbe06d&redirect_uri=http://localhost:8080/client&response_type=code&scope=read&state=M7bQDn");&ndash;%&gt;--%>
<%--&lt;%&ndash;//        response.sendRedirect("http://localhost:8081/tonr2");&ndash;%&gt;--%>
<%--&lt;%&ndash;//        return;&ndash;%&gt;--%>
<%--&lt;%&ndash;http://localhost:8080/ivis/oauth/authorize?client_id=2e9fa895-e577-4156-844a-2cbb1ebbe06d&redirect_uri=http://localhost:8080/client/api/content/ivis/code&response_type=code&scope=read&ndash;%&gt;--%>
<%--&lt;%&ndash;//    window.location.href = "http://localhost:8080/ivis/oauth/authorize?client_id=2e9fa895-e577-4156-844a-2cbb1ebbe06d&redirect_uri=http://localhost:8080/client/api/content/ivis/code&response_type=code&scope=read";&ndash;%&gt;--%>
<%--<script type="text/javascript">--%>
...
<%--&lt;%&ndash;<div class="mb-md">&ndash;%&gt;--%>
<%--&lt;%&ndash;<button id="addToTable" class="btn btn-primary" onclick="addApplication()">Add <i class="fa fa-plus"></i></button>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
