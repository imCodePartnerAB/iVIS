...
////        service.save(entity);
////        entity.getApplicationForm().setName(entity.getApplicationForm().getName());
////        service.save(entity);
////        entity.getApplicationForm().getQuestions().iterator().next().setValue("sdfasdfffffffffffffff");
//        entity.getQuestions().iterator().next().setValue("YYYYY");
//        service.save(entity);
//        TimeUnit.SECONDS.sleep(1);
//        EntityVersion version = new EntityVersion(entity);
//        ObjectOutputStream out = new ObjectOutputStream(new ByteArrayOutputStream(10240));
//        out.writeObject(entity);
//
//        version = service2.save(version);
//        ApplicationFormQuestion q1 = new ApplicationFormQuestion();
//        q1.setName("AppliedPupilPersonAddress.AppliedPupilGuardian1PersonNumber");
//        q1.setSortOrder(2);
//        q1.setText("Postnummer");
//        q1.setValue("123445");
//        q1.setMultiValues(Boolean.FALSE);
//        q1.setValues(Collections.singletonList("123445"));
//        q1.setMultiVariants(Boolean.FALSE);
//        q1.setVariants(Collections.emptyList());
//        q1.setValueType(String.class);
//
//        ApplicationFormQuestion q2 = new ApplicationFormQuestion();
//        q2.setName("AppliedPupilPersonAddress.AppliedPupilGuardian1PersonNumber");
//        q2.setSortOrder(2);
//        q2.setText("RadioButton");
//        q2.setValue("r1");
//        q2.setMultiValues(Boolean.FALSE);
//        q2.setValues(Collections.singletonList("123445"));
//        q2.setMultiVariants(Boolean.TRUE);
//        q2.setVariants(Arrays.asList("r1", "r2", "r3", "r4"));
//        q2.setValueType(String.class);
//
//        ApplicationFormQuestion q3 = new ApplicationFormQuestion();
//        q3.setName("AppliedPupilPersonAddress.AppliedPupilGuardian1Day");
//        q3.setSortOrder(2);
//        q3.setText("Days");
////        q3.setValue(Arrays.<String>asList("S", "M", "T", "W", "Th", "F", "St"));
//        q3.setMultiValues(Boolean.TRUE);
//        q3.setValues(Arrays.asList("S", "M", "F", "St"));
//        q3.setMultiVariants(Boolean.TRUE);
//        q3.setVariants(Arrays.asList("S", "M", "T", "W", "Th", "F", "St"));
//        q3.setValueType(String.class);
//        service.save(q1);
//        service.save(q2);
//        service.save(q3);
